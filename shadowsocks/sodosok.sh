...
# Link Hosting Kalian
donyoku="raw.githubusercontent.com/DonyokuKen/vpn_sh/refs/heads/arm64/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${donyoku}/addss.sh"
wget -O delss "https://${donyoku}/delss.sh"
wget -O cekss "https://${donyoku}/cekss.sh"
wget -O renewss "https://${donyoku}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
