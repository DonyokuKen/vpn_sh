...
# ==================================================
# Link Hosting Kalian
donyoku="raw.githubusercontent.com/DonyokuKen/vpn_sh/refs/heads/mainipsec"
...
wget -O /usr/bin/addl2tp https://${donyoku}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${donyoku}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${donyoku}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${donyoku}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${donyoku}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${donyoku}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
