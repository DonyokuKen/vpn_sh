...
# Link Hosting Kalian
donyoku="raw.githubusercontent.com/DonyokuKen/vpn_sh/refs/heads/arm64/sstp"
...
wget -O /etc/accel-ppp.conf "https://${donyoku}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${donyoku}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${donyoku}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${donyoku}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${donyoku}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
